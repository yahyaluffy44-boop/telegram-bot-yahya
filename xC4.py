...
#━━━━━━━━━━━━━━━━━━━━━━━━━━
#PUBLISH CHANNEL: RAFIN
#CHANNEL USERNAME: @YAHYA
#গেরেনার পুটকি মারছে : @YAHYA
#━━━━━━━━━━━━━━━━━━━━━━━━━━
...
async def ArA_CoLor():
    # Only bright, vivid colors (no dark/dull shades)
    Tp = [
        "32CD32",  # lime green
        ...
        "FF1493",  # deep pink
        "00FF7F",  # spring green
        "FF00FF",  # magenta (included but you can remove if you want)
        "00FFFF",  # cyan
        "FFFF00",  # yellow
        "FF7F50",  # coral
        "FFD700",  # gold
        ...
        "DDA0DD",  # plum
        "F0E68C",  # khaki (still bright enough)
        "F5DEB3",  # wheat (bright)
    ]
...
async def xSEndMsg(Msg , Tp , Tp2 , id , K , V):
    feilds = {1: id , 2: Tp2 , 3: Tp, 4: Msg, 5: 1735129800, 7: 2, 9: {1: "RAFIN", 2: int(await xBunnEr()), 3: 901048018, 4: 330, 5: 909034009, 8: "RAFIN", 10: 1, 11: 1, 13: {1: 2}, 14: {1: 12484827014, 2: 8, 3: "\u0010\u0015\b\n\u000b\u0013\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"}, 12: 0}, 10: "en", 13: {3: 1}}
...
async def xSEndMsgsQ(Msg , id , K , V):
    fields = {1: id , 2: id , 4: Msg , 5: 1756580149, 7: 2, 8: 904990072, 9: {1: "RAFIN", 2: await xBunnEr(), 4: 330, 5: 827001005, 8: "RAFIN", 10: 1, 11: 1, 13: {1: 2}, 14: {1: 1158053040, 2: 8, 3: "\u0010\u0015\b\n\u000b\u0015\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"}}, 10: "en", 13: {2: 2, 3: 1}}
